...
def rag(query, vectorstore, llm):
    ...
    prompt = f""" 
    You are a helpful assistant. Answer the question in detail using the context below.
    Be thorough and comprehensive. Explain with examples if possible. Aim for at least 3-5 sentences.
